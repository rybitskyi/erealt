...
privileged aspect LeaseFlat_Roo_Finder {
    
    public static Query LeaseFlat.findLeaseFlatsBySearchCriteria(SearchCriteria searchCriteria) {
        EntityManager em = LeaseFlat.entityManager();
        StringBuffer sb = new StringBuffer("SELECT o ");
        sb.append(" FROM LeaseFlat o WHERE ");
    ...
    public static long LeaseFlat.findLeaseFlatsBySearchCriteriaCount(SearchCriteria searchCriteria) {
        EntityManager em = LeaseFlat.entityManager();
