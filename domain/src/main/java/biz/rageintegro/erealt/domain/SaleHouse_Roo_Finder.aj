...
privileged aspect SaleHouse_Roo_Finder {
    
    public static Query SaleHouse.findSaleHousesBySearchCriteria(SearchCriteria searchCriteria) {
        EntityManager em = SaleHouse.entityManager();
        StringBuffer sb = new StringBuffer("SELECT o ");
        sb.append(" FROM SaleHouse o WHERE ");
    ...
    public static long SaleHouse.findSaleHousesBySearchCriteriaCount(SearchCriteria searchCriteria) {
        EntityManager em = SaleHouse.entityManager();
