...
privileged aspect LeaseHouse_Roo_Finder {
    
    public static Query LeaseHouse.findLeaseHousesBySearchCriteria(SearchCriteria searchCriteria) {
        EntityManager em = LeaseHouse.entityManager();
        StringBuffer sb = new StringBuffer("SELECT o ");
        sb.append(" FROM LeaseHouse o WHERE ");
    ...
    public static long LeaseHouse.findLeaseHousesBySearchCriteriaCount(SearchCriteria searchCriteria) {
        EntityManager em = LeaseHouse.entityManager();
